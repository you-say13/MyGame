...
import GameMenu from "./game_components/GameMenu";
import BattleMenu from "./game_components/BattleMenu";
...
import SelectEnemy from "./game_components/SelectEnemy";
import Data from "../Data/Enemy.json"
import User from "../Data/Player.json"
import { DamageChecker, Enemy, Key, Player } from "./game_components/Interface";
import UserStatus from "./game_components/UserStatus";
...
const Game = () => {
    ...
    const testhandler = ((e:KeyboardEvent) => {
        if(!e.repeat){
            ...
            const damgehandler : DamageChecker = {
                event: e,
                user:user,
